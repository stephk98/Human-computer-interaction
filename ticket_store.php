...
$stmt = $con->prepare('SELECT cardtype FROM accounts WHERE id = ?');
...
?>
  <body>
      ...
      <nav class="navbar navbar-inverse bg-inverse bg-faded">
        <div class="row">
            <div class="col">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cart">Καλαθι (<span class="total-count"></span>)</button>
              <button class="clear-cart btn btn-danger">διαγραφη καλαθιου</button></div>
        </div>
    </nav>
           <?php 
        if ((isset($_SESSION['loggedin'])) AND ($cardtype=="Μειωμένο") ) {?>
      ...
      <section class="probootstrap-section" style="padding-top:0%">
        <div class="container black_text " style="text-align: center;">
          ...
          <div class="row ">
            <div class="col " >
                <div class="boxed">ΕΝΙΑΙΟ ΕΙΣΙΤΗΡΙΟ<br>1,40€</div>
                <button class="btn_shop add-to-cart " data-name="ΕΝΙΑΙΟ_ΕΙΣΙΤΗΡΙΟ" data-price="1.40">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">2πλό ΕΝΙΑΙΟ<br>2,70€</div>
                <button class="btn_shop add-to-cart" data-name="2πλό_ΕΝΙΑΙΟ" data-price="2.70">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">5πλό ΕΝΙΑΙΟ ΕΙΣΙΤΗΡΙΟ <br>6,50€</div>
                <button class="btn_shop add-to-cart" data-name="5πλό_ΕΝΙΑΙΟ_ΕΙΣΙΤΗΡΙΟ" data-price="6.50">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">10+1 ΕΙΝΑΙΑ ΕΙΣΙΤΗΡΙΑ<br>13,50€</div>
                <button class="btn_shop add-to-cart" data-name="10+1_ΕΙΝΑΙΑ_ΕΙΣΙΤΗΡΙΑ" data-price="13.50">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
        ...
        <div class="container black_text" style="text-align: center;">
          ...
          <div class="row">
            <div class="col" >
                <div class="boxed">30 ημερών<br>30 €</div>
                <button class="btn_shop add-to-cart" data-name="30_ημερών" data-price="30.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">90 ημερών<br>85 €</div>
                <button class="btn_shop add-to-cart" data-name="90_ημερών" data-price="85.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">180 ημερών<br>170 €</div>
                <button class="btn_shop add-to-cart" data-name="180_ημερών" data-price="170.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            <div class="col" >
                <div class="boxed">365 ημερών<br>330 €</div>
                <button class="btn_shop add-to-cart" data-name="365_ημερών" data-price="330.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
            </div>
            </div>

            <div class="row" style="margin-top: 40px;">
                <div class="col" >
                    <div class="boxed">30 ημερών<br>49 €</div>
                    <button class="btn_shop add-to-cart" data-name="30_ημερών" data-price="49.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
                </div>
                <div class="col" >
                    <div class="boxed">90 ημερών<br>142 €</div>
                    <button class="btn_shop add-to-cart" data-name="90_ημερών" data-price="142.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
                </div>
                <div class="col" >
                    <div class="boxed">180 ημερών<br>250 €</div>
                    <button class="btn_shop add-to-cart" data-name="180_ημερών" data-price="250.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
                </div>
                <div class="col" >
                    <div class="boxed">365 ημερών<br>490 €</div>
                    <button class="btn_shop add-to-cart" data-name="365_ημερών" data-price="490.00">ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ</button>
                </div>
                </div>
          </div>
        </div>
